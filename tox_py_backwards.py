...
def tox_addoption(parser):
    ...
    parser.add_testenv_attribute(
        ...
        type="line-list",
        default=(),
        help='list of files/dirs to be converted by py-backwards before running tests',  # noqa: #501
    )
